...
'Declaring and calculating variables
  Dim i As Long
...
'Getting stock value at beginning of year
  
       Open_Yearly_Price = ws.Cells(Open_Price_Row, 3).Value

'Loop through work sheet starting at row 2

  For i = 2 To lastRow
  

'If next ticker cell /= previous ticker cell print value in colomn "I"
